...
class LevelEvaluator:
    ...
    @staticmethod
    def _extract_strong_password_durations(recent_sessions: list, take: int) -> list:
    ...
    def evaluate_strong_password_activity(
        ...
        durs_up = LevelEvaluator._extract_strong_password_durations(
            recent_sessions, up_n
        )
        ...
        durs_down = LevelEvaluator._extract_strong_password_durations(
            recent_sessions, down_n
        )
